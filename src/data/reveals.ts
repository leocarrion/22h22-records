...
export const reveals: Reveal[] = [
  ...
  ], message: "Mon Pic'Pic, toi et moi on a connecté musicalement par notre amour respectif pour la House Music. Très sûrement le point de départ de notre belle amitié de gros baiseurrrrrs. \nSur l'énorme quantité de titres qu'on s'est partagés depuis le début, c'est clairement la House qui ressort le plus. J'ai donc choisi ce titre parce que c'est mon fav parmi tous ceux que tu m'as fait découvrir, et sur lequel je te revois hocher la tête et les rides quand tu m'as vu le jouer la seule fois où j'ai mixé en public il y a quelques années. Et si t'es pas content du titre ou de la version, sache que c'était ça ou la BO de Père Castor pour toutes tes tunnel-anecdotes de vieux bourlingueur de la musique. Donc estime-toi heureux ! Allez bisous ma vieille branche ancestrale fossilisée et enjoy ce miel qui date de 1996 (plus vieux que moi mais clairement plus jeune que toi bahahaha)" },
]
